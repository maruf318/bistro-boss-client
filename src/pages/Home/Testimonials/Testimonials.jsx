...
const Testimonials = () => {
  ...
  useEffect(() => {
    fetch("https://bistro-boss-server-three-sage.vercel.app/reviews")
      .then((res) => res.json())
      ...
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        {reviews.map((review) => (
          <SwiperSlide key={review._id}>
            <div className="flex flex-col items-center my-4 md:my-10 mx-24 space-y-6">
              <Rating
                style={{ maxWidth: 180 }}
                value={review.rating}
                readOnly
              ...
              <p className=" text-[#444] text-xl">{review.details}</p>
